...
Note that no variant achieves genome-wide significant (dashed line). However, we do peaks in the plot. If we smooth the odds ratio data, these peaks become even clearer:
