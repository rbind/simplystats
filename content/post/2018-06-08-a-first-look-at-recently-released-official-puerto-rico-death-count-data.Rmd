---
title: Estimating mortality rates in Puerto Rico after hurricane Maria using newly released official death counts
...
```{r excess-death-rate,echo=FALSE}
