...
It's a pet peeve but there is somewhat a practical reason as well. To demonstrate I created a dataset called `dat` that contains an outcome `value` for from 25 different groups.
...
Note how quickly we notice the bimodal group. I am hoping people start using joyplots instead of violin plots.
