...
```
It's a pet peeve but there is somewhat of a practical reason as well. To demonstrate I created a dataset called `dat` that contains an outcome `value` for from `r p` different groups.
